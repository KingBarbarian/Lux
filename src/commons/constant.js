...
// CustomerSourceType.set('6', '农分期活动');
// CustomerSourceType.set('6', '农分期活动');
CustomerSourceType.set(0, "地面推广"), CustomerSourceType.set(
  1,
  "经销商介绍"
), CustomerSourceType.set(4, "政府介绍"), CustomerSourceType.set(
  3,
  "客户介绍"
), CustomerSourceType.set(26, "营销活动"), CustomerSourceType.set(27, "电话&线上");
//
...
MaritalState.set(0, "未婚"), MaritalState.set(1, "已婚"), MaritalState.set(
  2,
  "离婚"
), MaritalState.set(3, "丧偶"), MaritalState.set(4, "再婚");
// 工作类型
const WorkState = new Map();
WorkState.set(0, "参与生意"), WorkState.set(1, "务农"), WorkState.set(
  2,
  "单独经营"
), WorkState.set(3, "工作"), WorkState.set(4, "年幼"), WorkState.set(
  5,
  "上学"
), WorkState.set(6, "无事");
// 居住类型
const ResideType = new Map();
ResideType.set(0, "其他"), ResideType.set(1, "自有住宅"), ResideType.set(
  2,
  "租赁"
), ResideType.set(3, "按揭住宅"), ResideType.set(4, "经营场所"), ResideType.set(
  5,
  "与亲属共住"
);
...
RelationType.set(1, "儿子"), RelationType.set(2, "女儿"), RelationType.set(
  3,
  "父亲"
), RelationType.set(4, "母亲"), RelationType.set(5, "丈夫"), RelationType.set(
  6,
  "妻子"
);
